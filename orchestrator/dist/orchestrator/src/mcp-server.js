...
import { runConfigSchema } from '../../agents/schemas.js';
const router = new ResumeRunRouter();
const server = new McpServer({
    name: 'resume-orchestrator',
    version: '0.1.0'
});
const runStatusValues = ['pending', 'running', 'needs_review', 'failed', 'completed'];
...
server.registerTool('create-run', {
